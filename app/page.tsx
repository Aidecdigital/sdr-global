        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-gray-900 mb-8 leading-tight">
              The Global Infrastructure for <span className="text-blue-600">Sales Development</span>
            </h1>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="group relative rounded-2xl border border-gray-200 bg-white p-10 hover:border-blue-200 hover:shadow-lg transition-all duration-300">
              ...
              <ul className="space-y-3 mb-8 text-gray-600">
                <li className="flex items-center"><span className="w-1.5 h-1.5 bg-blue-600 rounded-full mr-2"></span>Reduce hiring time by 90%</li>
