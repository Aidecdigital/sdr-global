          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Traditional hiring is slow, expensive, and risky. You spend
                months recruiting and training, only to face high turnover and
              ...
              <div className="space-y-6">
                {[
                  {
                    title: "Slow Ramp-up",
                    desc: "90+ days to hire and train a productive SDR.",
                  },
                  {
                    title: "High Costs",
                    desc: "$50k+ average cost to replace a failed hire.",
                  },
                  {
                    title: "Management Drain",
                    desc: "Countless hours spent on coaching basics.",
                  },
                ].map((item, i) => (
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 md:p-12 relative overflow-hidden">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-6">
                The SDR Global Standard
              </h3>
              <div className="space-y-6">
                {[
                  {
                    title: "Instant Deployment",
                    desc: "Pre-vetted, certified talent ready in 24 hours.",
                  },
                  {
                    title: "Zero Ramp Time",
                    desc: "SDRs arrive trained on your stack and methodology.",
                  },
                  {
                    title: "Global Scale",
                    desc: "Hire in any time zone, language, or region.",
                  },
                ].map((item, i) => (
                  <div key={i} className="flex gap-4">
              ...
              <div className="mt-10 pt-8 border-t border-gray-100">
                <Link
                  href="/hire-sdrs#process"
                  className="text-[#0055ae] font-semibold hover:text-blue-700 flex items-center"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Connecting world-class companies with world-class talent.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="group relative rounded-2xl border border-gray-200 bg-white p-10 hover:border-blue-200 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-600 mb-8 h-12">
                Scale your sales team without the headache. Hire pre-trained,
                certified SDRs instantly.
              </p>
            ...
            <div className="group relative rounded-2xl border border-gray-200 bg-white p-10 hover:border-green-200 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-600 mb-8 h-12">
                Launch your global sales career. Get certified and matched with
                top tech companies.
              </p>
              <ul className="space-y-3 mb-8 text-gray-600">
                <li className="flex items-center">
                ...
                <li className="flex items-center">
                  <span className="w-1.5 h-1.5 bg-green-600 rounded-full mr-2"></span>
                  Career mentorship & growth
                </li>
              </ul>
              <Link
                href="/work#talent-form"
